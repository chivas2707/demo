    ...
    <div>
      ...
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Đang giao hàng</Card.Title>
              <Card.Text>
        ...
        <Col md={4}>
          <Card>
            <Card.Body>
              <Card.Title>Tóm tắt hóa đơn</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Sản phẩm</Col>
                    <Col>{cart.itemsPrice.toFixed(2)} VNĐ</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Phí giao hàng</Col>
                    <Col>{cart.shippingPrice.toFixed(2)} VNĐ</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>VAT</Col>
                    <Col>{cart.taxPrice.toFixed(2)} VNĐ</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>

...
const prices = [
  {
    name: '0 to 500.000 VNĐ',
    value: '0 - 500000',
  },
  {
    name: '500.000 VNĐ to 1.000.000 VNĐ',
    value: '500000 - 1000000',
  },
  {
    name: '1.000.000 to 2.000.000 VNĐ ',
              ...
              <Row className="justify-content-between mb-3">
                <Col md={6}>
                  <div>
                    ...
                    {price !== 'all' && ' : Giá ' + (price.toString())}
                    {rating !== 'all' && ' : Đánh giá ' + rating + ' sao và hơn'}
                    {query !== 'all' ||
                    category !== 'all' ||
                    rating !== 'all' ||
                    price !== 'all' ? (
